...
| --- | --- | --- | --- |
| DigitalOcean App Platform skills | github.com/digitalocean-labs/do-app-platform-skills | `npx skills add digitalocean-labs/do-app-platform-skills` | Twelve skills for app-spec generation, managed Postgres defaults, VPC, GitHub Actions deploys, secrets via bindable variables, Heroku migration, troubleshooting. Published by DigitalOcean 2026-03-16. Not installed locally yet; install it first. |
